    ...
    def user_registration(self):
        ...
        def exit_program():
            ...
            try:
                ...
                messagebox.showinfo(title="Alert", message="Enter Valid mobile number", parent=user_registration_root)
            ...
            if (name == ""):
                ...
                messagebox.showinfo(title="Alert", message="Enter 10 Digit mobile number", parent=user_registration_root)
            elif (email == ""):
                messagebox.showinfo(title="Alert", message="Enter Email", parent=user_registration_root)
            elif "@" not in email:
                messagebox.showinfo(title="Alert", message="Enter Valid Email", parent=user_registration_root)
            elif (address == ""):
